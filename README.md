...
2. Upload `line_accession_metadata.csv` into the table `line_accession` first using the Retool Database Editor.
3. Upload `plant_metadata.csv` into the table `plant` using the Retool Database Editor.
